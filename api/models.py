...
class CustomerProduct(models.Model):
    transaction = models.ForeignKey(CustomerTransaction, on_delete=models.CASCADE, related_name='product')
    prod_name = models.CharField(max_length=50)
    prod_quantity = models.IntegerField()
    total_price = models.DecimalField(max_digits=20, decimal_places=2)

class CustomerPayment(models.Model):
    transaction = models.ForeignKey(CustomerTransaction, on_delete=models.CASCADE, related_name='payment')
